...
for _, ls in ipairs({'bashls', 'gopls', 'pylsp'}) do
  require('lspconfig')[ls].setup {
    ...
    on_attach = function(_, buf)
      ...
      vim.keymap.set('n', 'grd', fzf_lua.lsp_definitions, {buffer = buf})
      vim.keymap.set('n', 'gre', fzf_lua.lsp_workspace_diagnostics, {buffer = buf})
      vim.keymap.set('n', 'gri', fzf_lua.lsp_implementations, {buffer = buf})
      vim.keymap.set('n', 'grr', fzf_lua.lsp_references, {buffer = buf})
